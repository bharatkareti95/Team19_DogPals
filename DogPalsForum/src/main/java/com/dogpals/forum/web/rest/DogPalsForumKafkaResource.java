...
@RestController
@RequestMapping("/api/dog-pals-forum-kafka")
public class DogPalsForumKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DogPalsForumKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DogPalsForumKafkaResource(KafkaProperties kafkaProperties) {
