...
@RestController
@RequestMapping("/api/dog-pals-training-kafka")
public class DogPalsTrainingKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DogPalsTrainingKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DogPalsTrainingKafkaResource(KafkaProperties kafkaProperties) {
