...
describe('Service Tests', () => {
  describe('Information Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(InformationService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Information(0, 'AAAAAAA', 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            dateposted: currentDate.format(DATE_FORMAT),
          },
          elemDefault
        );
      ...
      it('should create a Information', () => {
        ...
        service.create(new Information()).subscribe(resp => (expectedResult = resp.body));
