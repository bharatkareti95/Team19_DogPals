...
export class InformationService {
  ...
  protected convertDateFromClient(information: IInformation): IInformation {
    const copy: IInformation = Object.assign({}, information, {
      dateposted: information.dateposted && information.dateposted.isValid() ? information.dateposted.format(DATE_FORMAT) : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((information: IInformation) => {
        information.dateposted = information.dateposted ? moment(information.dateposted) : undefined;
      });
    }
    return res;
  }
