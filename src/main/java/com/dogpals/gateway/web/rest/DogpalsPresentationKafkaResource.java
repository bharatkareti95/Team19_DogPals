...
@RestController
@RequestMapping("/api/dogpals-presentation-kafka")
public class DogpalsPresentationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DogpalsPresentationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DogpalsPresentationKafkaResource(KafkaProperties kafkaProperties) {
