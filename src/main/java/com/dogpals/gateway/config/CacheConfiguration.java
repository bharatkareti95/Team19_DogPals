package com.dogpals.gateway.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.dogpals.gateway.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.dogpals.gateway.repository.UserRepository.USERS_BY_EMAIL_CACHE);
