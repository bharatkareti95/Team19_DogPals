...
export class ForumComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.forumService
        ...
        .subscribe(
          (res: HttpResponse<IForum[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInForums(): void {
    this.eventSubscriber = this.eventManager.subscribe('forumListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IForum[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
