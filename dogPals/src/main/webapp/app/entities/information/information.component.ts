...
export class InformationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.informationService
        ...
        .subscribe(
          (res: HttpResponse<IInformation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInInformation(): void {
    this.eventSubscriber = this.eventManager.subscribe('informationListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IInformation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
