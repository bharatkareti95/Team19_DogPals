...
@RestController
@RequestMapping("/api/dog-pals-kafka")
public class DogPalsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DogPalsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DogPalsKafkaResource(KafkaProperties kafkaProperties) {
